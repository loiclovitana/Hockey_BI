...
export type GetAdminUserAdminUserGetResponse =
  GetAdminUserAdminUserGetResponses[keyof GetAdminUserAdminUserGetResponses];
...
export type GetOperationAdminOperationGetResponse =
  GetOperationAdminOperationGetResponses[keyof GetOperationAdminOperationGetResponses];
...
export type GetPlayersPlayersGetResponse =
  GetPlayersPlayersGetResponses[keyof GetPlayersPlayersGetResponses];
...
export type GetPlayerPlayersIdPlayerIdGetError =
  GetPlayerPlayersIdPlayerIdGetErrors[keyof GetPlayerPlayersIdPlayerIdGetErrors];
...
export type GetPlayerStatsPlayersStatsIdPlayerIdGetError =
  GetPlayerStatsPlayersStatsIdPlayerIdGetErrors[keyof GetPlayerStatsPlayersStatsIdPlayerIdGetErrors];
...
export type GetPlayerStatsPlayersStatsIdPlayerIdGetResponse =
  GetPlayerStatsPlayersStatsIdPlayerIdGetResponses[keyof GetPlayerStatsPlayersStatsIdPlayerIdGetResponses];
...
export type GetLatestPlayerStatsPlayersLatestGetResponse =
  GetLatestPlayerStatsPlayersLatestGetResponses[keyof GetLatestPlayerStatsPlayersLatestGetResponses];
...
export type LoadMyteamLoadPostError =
  LoadMyteamLoadPostErrors[keyof LoadMyteamLoadPostErrors];
...
export type LoadMyteamLoadPostResponse =
  LoadMyteamLoadPostResponses[keyof LoadMyteamLoadPostResponses];
...
export type LoginAdminLoginPostError =
  LoginAdminLoginPostErrors[keyof LoginAdminLoginPostErrors];
...
export type LoginAdminLoginPostResponse =
  LoginAdminLoginPostResponses[keyof LoginAdminLoginPostResponses];
